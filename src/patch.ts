...
function replaceVnode(prevVNode, vnode, container) {
  ...
  if (prevVNode.flags & VNODE_FLAGS.COMPONENT_STATEFULL) {
          ...
          const diffFromTwoEnd = function() {
            ...
            if (oldStartIdx > oldEndIdx) {
              ...
              for (let i = newStartIdx; i <= newEndIdx; i++) {
                mount(nextChildren[i], parentEl, false, oldStartNode && oldStartNode.el)
              }
