...
//     return this.firstChild?h(ChildCompo,{text:this.localState}):h(Child2,{text:this.localState}); // 渲染子组件
//   }
// }
// class ChildCompo{
//   render(){
//     const {text}=this.$props;
//     return h('h1',{style:{color:'#999'}},text)
//   }
// }
// class Child2{
//   render(){
//     const {text}=this.$props;
//     return h('h1',{style:{color:'#999'}},text+'--child2')
//   }
// }
// render(h(Compo1,null,null),document.getElementById('app'))
...
//   }
//   render() {
//     // return this.firstChild ? h(FC1, { text: this.text }) : h(FC2, { text: this.text })
//     return h(FC1,{text:this.text})
//   }
// }

// function FC1({ text }) {
//   return text.indexOf(1)>-1? h('h1', { style: { color: '#000' } }, text):h('h2', { style: { color: '#f00' } }, text)
// }

// function FC2({ text }) {
//   return h('h2', { style: { color: '#f00' } }, text)
// }
